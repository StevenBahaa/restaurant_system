...
1. **Manual Availability Refresh**: RPC controller to pull fresh availability mapping arrays asynchronously mid-session.
2. **Combo Component Routing**: Route combo components to individual stations based on their component product station assignments.
